...
from torchvision.transforms import Compose , ToTensor , Resize, RandomAffine,ColorJitter, Normalize, RandomHorizontalFlip
...
def get_args():
    ...
    parser.add_argument("--root","-r", type= str, default="./dataset_celeba_mini", help="Root")
    parser.add_argument("--epochs","-e", type= int, default=100, help="Number of epochs")
    parser.add_argument("--batch-size","-b", type= int, default=32, help="Number of epochs")
    ...
    parser.add_argument("--max-norm","-m", type=float, default=1.0, help="Max norm for gradient clipping")
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        print("Epoch {}: Accuracy: {:.4f}".format(epoch + 1, accuracy_score(all_labels, all_predictions)))
